...
| `AzPolicyLensModuleVersion` | The version of the AzPolicyLens module to be used in the pipelines. The specific version will be installed from the PowerShell Gallery. If not specified, the latest version will be used. | `2.3.3` |
